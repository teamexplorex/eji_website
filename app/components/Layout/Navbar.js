          ...
          <div>
            <ul>
              ...
              <li
                ...
                onClick={() => router.push("https://plan-n-go.in/")}
              >
                {" "}
                <div>Flights</div>
              </li>
              ...
              <li className={classes.dropdownContainer}>
                ...
                <div className={classes.popup}>
                  ...
                  >
                    <Link href="https://plan-n-go.in/">Flights</Link>
                  </p>
                  <p
                    onClick={() => router.push("https://plan-n-go.in/")}
                    className={classes.hotels_more}
                  >
                    <Link href="https://plan-n-go.in/">Hotels</Link>
                  </p>
                  ...
                  <p onClick={() => router.push("https://plan-n-go.in/")}>
                    {" "}
                    <Link href="https://plan-n-go.in/">Visa</Link>
                  </p>
                  <p onClick={() => router.push("https://plan-n-go.in/")}>
                    {" "}
                    <Link href="https://plan-n-go.in/">Transfers</Link>
                  </p>
